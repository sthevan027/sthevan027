...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="https://capsule-render.vercel.app/api?type=waving&color=0:0A0A0A,100:0A66C2&height=200&section=header&text=Sthevan%20Santos&fontSize=48&fontColor=ffffff&animation=fadeIn&fontAlignY=38&desc=Full-Stack%20Software%20Engineer%20%C2%B7%20Founder%20%40%20Virex&descAlignY=58&descSize=20" />
  <img src="https://capsule-render.vercel.app/api?type=waving&color=0:0A66C2,100:003B57&height=200&section=header&text=Sthevan%20Santos&fontSize=48&fontColor=ffffff&animation=fadeIn&fontAlignY=38&desc=Full-Stack%20Software%20Engineer%20%C2%B7%20Founder%20%40%20Virex&descAlignY=58&descSize=20" alt="Banner" width="100%" />
</picture>
...
const sthevan = {
  ...
  focus: [
    "Sistemas de gestão",
    "Dashboards orientados a dados",
    "Automação de processos"
  ],
  stack: {
    frontend: ["React", "Next.js", "TypeScript"],
    backend:  ["Node.js", "Python"],
    database: ["Supabase", "MongoDB", "SQLite"]
  },
  currently: "Construindo a Virex e aberto a novas colaborações"
};
```
...
<p align="center">
  <img src="https://komarev.com/ghpvc/?username=sthevan027&color=0A66C2&style=flat&label=VISITANTES" alt="Visitantes" />
